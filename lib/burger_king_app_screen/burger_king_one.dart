...
import 'package:submission_project/burger_king_app_screen/burger_king_two.dart';
import 'package:submission_project/common_button_.dart';

class SecondScreenAppTwo extends StatefulWidget {
  const SecondScreenAppTwo({Key? key}) : super(key: key);

  @override
  State<SecondScreenAppTwo> createState() => _SecondScreenAppTwoState();
}

class _SecondScreenAppTwoState extends State<SecondScreenAppTwo> {
